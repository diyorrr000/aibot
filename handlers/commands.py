...
USERBOT_COMMANDS = {
    ...
    ".ping":       ("🏓 Ping", "Botning ishlash holatini tekshiradi. Javob: Pong!"),
    ".ai":         ("🤖 AI savol", "AI ga savol berish. Misol: .ai Uzbekiston poytaxti qaysi?"),
    ".grok":       ("🌌 Grok AI", "Grok modeli orqali savol berish. Misol: .grok kelajak haqida ayt"),
    ".tr":         ("🌐 Tarjima", "Xabarni tarjima qiladi. Misol: .tr ru Hello world — ruscha tarjima."),
    ".tts":        ("🗣 Ovozli xabar", "Matnni ovozga aylantiradi. Misol: .tts Salom, qalaysiz?"),
    ".co":         ("💫 Animatsiya", "Animatsiya effekti. Misol: .co salom"),
    ".love":       ("❤️ Love animatsiya", "Sevgi animatsiyasi. Misol: .love"),
    ".clock":      ("🕒 Profil soati", "Profil ismiga soat qo'shadi (O'zbekiston vaqti)."),
    ".yt":         ("▶️ YouTube", "YouTube dan video/audio yuklab olish. Misol: .yt https://youtu.be/..."),
    ".tt":         ("🎵 TikTok", "TikTok dan video yuklab olish. Misol: .tt https://tiktok.com/..."),
    ".weather":    ("⛅ Ob-havo", "Shahar ob-havosini ko'rsatadi. Misol: .weather Toshkent"),
    ".q":          ("💬 Iqtibos", "Random motivatsion iqtibos yuboradi."),
    ".meme":       ("😂 Meme", "Random meme yuboradi."),
    ".baza":       ("🗃 Ma'lumot", "Ma'lumotlar bazasidan qidirish."),
    ".anime":      ("🎌 Anime rasm", "Anime rasm yuboradi."),
    ".currency":   ("💱 Valyuta", "Valyuta kurslari. Misol: .currency USD"),
    ".lyrics":     ("🎵 Qo'shiq matni", "Qo'shiq so'zlarini topadi. Misol: .lyrics Shahlo Baxtiyorova"),
    ".roulette":   ("🎰 Ruletka", "Ruletka o'yini."),
    ".roleplay":   ("🎭 Rol o'ynash", "Rol o'ynash rejimi."),
    ".read":       ("📄 Fayl o'qish", "Faylni o'qiydi va mazmunini aytadi."),
    ".upload":     ("📤 Yuklash", "Faylni Telegraph ga yuklaydi."),
    ".telegraph":  ("📝 Telegraph", "Telegraph ga post yuboradi."),
    ".gender":     ("👤 Jins aniqlash", "Ism orqali jinsni taxmin qiladi. Misol: .gender Sardor"),
    ".shortlink":  ("🔗 Qisqa havola", "URL ni qisqartiradi. Misol: .shortlink https://..."),
